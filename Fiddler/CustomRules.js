...
class Handlers
{
	...
	*/
	public static RulesOption("Focus SIF messages")
	BindPref("fiddlerscript.rules.FocusSIF")
	var m_focusSIF: boolean = false;
	/*
	:: BEGIN SIF RULE OPTION
	*/
	...
	static function OnBeforeRequest(oSession: Session) {
		...
		:: BEGIN SIF RULES
		*/
		// In the 3.2 specification there is no mandatory header property in all requests, responses and events. This does a best guess to identify SIF messages.
		if (m_focusSIF) {
