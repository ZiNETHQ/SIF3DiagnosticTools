...
echo AT THIS TIME NA DOES NOT HAVE A LOCALE REPOSITORY
echo When the NA community sets up their repositories this will be edited
goto end

set ORIGIN=https://github.com/Access4LearningNA
...
echo.
echo Syncing A4L (NA) repositories
echo -----------------------------
echo Uses:
